...
export class Screen {
    ...
    static screenToWorld(x, y, camera) {
    ...
    setLevel(level) {
        ...
        if (name === '1-1')
            this.bgImage = Resources.BG0;
        else if (name === '1-2')
            this.bgImage = Resources.BG1;
        else if (name === '1-3')
            this.bgImage = Resources.BG2;
        else if (name === '1-4')
            this.bgImage = Resources.BG3;
        else if (name === '1-B')
            this.bgImage = Resources.BG4;
        else
            this.bgImage = undefined;
    }
    showLogo(show) { this.logoScreen = show; }
...
Screen.PIXELS_IN_WORLD = 50.0;
Screen.SCREEN_WIDTH = (650 / 43) * Screen.PIXELS_IN_WORLD;
Screen.SCREEN_HEIGHT = (450 / 650) * Screen.SCREEN_WIDTH;
